...
func (r ApiGetMoversRequest) Sort(sort string) ApiGetMoversRequest {
	r.sort = &sort
	return r
}
...
func (r ApiGetMoversRequest) Execute() (*GetMovers200Response, *http.Response, error) {
...
func (a *MoversAPIService) GetMoversExecute(r ApiGetMoversRequest) (*GetMovers200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetMovers200Response
	)
	...
	localVarPath := localBasePath + "/movers/{symbol_id}"
